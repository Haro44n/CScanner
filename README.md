...
🛡 Roadmap
[ ] Password Audit Module: Local rockyou.txt integration for instant credential leak checks.

[ ] Proxy Support: Rotating proxies to bypass rate-limiting on 60+ threads.

[ ] Report Export: Auto-generating HTML/JSON reports after the scan.
